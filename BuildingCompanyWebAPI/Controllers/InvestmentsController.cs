...
namespace BuildingCompanyWebAPI.Controllers
{
    ...
    public class InvestmentsController : ControllerBase
    {
        ...
        public InvestmentsController(BuildingCompanyContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.Investments.Include(i => i.Investor).ToListAsync();
        }
        ...
        {
            var investment = await _context.Investments.Include(i => i.Investor).FirstOrDefaultAsync(e => e.Id == id);
